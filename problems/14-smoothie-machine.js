...
const smoothieMachine = (...ingredients) => {
  // Your code here
  //returning a function that takes in any number of parameters using rest
  return (...moreingredients)=>{
    //create a variable that takes in all the ingredients...
    const allIngredients = [...ingredients,...moreingredients];
    //using join to combine all the ingredients using and
    const message = "I'm having a smoothie with "+ allIngredients.join(" and ");
